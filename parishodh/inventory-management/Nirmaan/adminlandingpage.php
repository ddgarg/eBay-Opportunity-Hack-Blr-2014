<?php
	session_start();
	if($_SESSION['name'] != null && $_SESSION['role'] == 'admin'){
		echo '
	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$("#adminrawmaterials").click(function(){
					$(location).attr("href","http://vasavitemple.org/hackathon/inventory/adminrawmaterials.php");
				});
			...
			<div id="splitlayout" class="splitlayout">
				<div class="intro">
					<div class="side side-left">
						...
						<div class="intro-content" id="adminrawmaterials">
